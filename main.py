...
def home_page():
    ...
    add_item_button.config(font=('comic sans', 20))
    ...
    remove_item_button.config(font=('comic sans', 20))
    ...
    new_order_button.config(font=('comic sans', 20))
    ...
    quit_button.config(font=('comic sans', 20))
