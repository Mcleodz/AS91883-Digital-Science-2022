...
def invalid_price():
    invalid_price = Tk()
    invalid_price.geometry("1000x250")
...
def invalid_quantity():
    ...
    Label(invalid_quantity, text="This is an invalid Quantity, Please input a whole number to continue", font=("Times New Roman", 20, "bold")).pack()
